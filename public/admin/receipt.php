...
if (isset($_GET['id_booking'])) {
    ...
    $booking = $admin->getBookingById($id_booking);
            ...
            <div class="receipt-container">
                <div class="receipt-header">
                    <div class="receipt-title">
                        <i class="fas fa-receipt me-2"></i>STRUK PEMBAYARAN - <?php echo htmlspecialchars($booking['usernama'] ?? 'N/A'); ?>
                    </div>
                    <div class="receipt-subtitle">
                        Booking PlayStation - <?php echo ucfirst($booking['payment_method'] ?? 'Cash'); ?>
                    </div>
                </div>
                ...
                <div class="receipt-body">
                    ...
                    <div class="receipt-row">
                        ...
                        <span class="receipt-value"><?php echo htmlspecialchars($booking['usernama'] ?? 'N/A'); ?> (ID: <?php echo $booking['id_user']; ?>)</span>
                    </div>
                    <div class="receipt-row">
                        <span class="receipt-label">PlayStation:</span>
                        <span class="receipt-value"><?php echo htmlspecialchars($booking['nama_playstation'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="receipt-row">
                ...
                <div class="text-center">
                    ...
                    <a href="cashier.php" class="btn btn-secondary ms-2">
